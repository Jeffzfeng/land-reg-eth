...
import TrufflePng from '../assets/truffle.png'
      ...
      <div className="Home">
        <main className="container">
            ...
            <div className="title-pic">
              <img className="metamask" src={MetamaskPng} alt="maskpic"/>
              <img src={ReactPng} alt="reactpic"/>
              <img src={EthPng} alt="ethpic"/>
              <img className="truffle" src={TrufflePng} alt="trufpic"/>
            </div>
        </main>
      </div>
    );
